...
class JewelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jewel" do
    assert_difference('Jewel.count') do
      post jewels_url, params: { jewel: { desc: @jewel.desc, image: @jewel.image, name: @jewel.name, price: @jewel.price, size: @jewel.size, type: @jewel.type } }
    end
  ...
  test "should update jewel" do
    patch jewel_url(@jewel), params: { jewel: { desc: @jewel.desc, image: @jewel.image, name: @jewel.name, price: @jewel.price, size: @jewel.size, type: @jewel.type } }
